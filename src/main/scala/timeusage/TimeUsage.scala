...
object TimeUsage {
  ...
  def timeUsageSummary(
    ...
    def createSumColumn(columns: List[Column])(alias: String) = columns.reduce(_ + _).divide(60).as(alias)

    val primaryNeedsProjection: Column = createSumColumn(primaryNeedsColumns)("primaryNeeds")
    val workProjection: Column = createSumColumn(workColumns)("work")
    val otherProjection: Column = createSumColumn(otherColumns)("other")
